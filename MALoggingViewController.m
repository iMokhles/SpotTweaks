...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *growBtn = [[UIBarButtonItem alloc] initWithTitle:@"Grow Font" style:UIBarButtonItemStylePlain target:self action:@selector(increaseFontSize)];
    UIBarButtonItem *doneBtn = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(dismisThisVC)];
    ...
    [self.navigationItem setRightBarButtonItems:@[doneBtn, growBtn]];
}
